...
class Qtest(object):
  ...
  def create_requirement(self,parent_id=None,properties=None, name=None):
      # row ['test case name']
      # row['start_datetime']
      # row['step_description']
      ...
      logging.info("Create Requirement Body: " + str(body) )
      endpoint = 'projects/' + str(self.proj_id) + '/' + 'requirements'
      parameters = None
      ...
      match obj_type:
          ...
          case 'test-suite':
              ...
              if create:
                  ...
                  data = self.post_request(endpoint,params,body,None)
          case 'requirement':
              endpoint = 'projects/' + str(self.proj_id) + '/' + 'requirement'
              params = {'parentId': parentId, 'parentType': 'module' }
              data = None
              # Create Only
              if create:
                  self.logger.info("Create " + obj_type + " :" + str(name) + " Parent ID: " + str(parentId) )
                  ...
                  # Create Object                  
                  data = self.create_requirement(parentId,properties,name)
...
#              raise
  ...
  def approve_tc(self,tc_id=None):
       # Approve the Test Case
      endpoint = 'projects/' + str(self.proj_id) + '/' + 'test-cases/'+ str(tc_id) + '/approve'
